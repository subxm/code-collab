  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* Center navigation */}
        <div className="hidden md:flex items-center gap-8 absolute left-1/2 transform -translate-x-1/2" role="menubar" aria-label="Primary">
          {navItems.map((item) => (
            <button
              key={item}
        ...
        {/* Right side: Mobile menu + Theme toggle + Auth Buttons */}
        ...
        <div className={`mx-4 my-2 rounded-xl p-4 ${theme === "dark" ? "bg-zinc-900/95" : "bg-white/95"} shadow-lg`}> 
          <nav className="flex flex-col gap-3" role="menu">
            ...
            <Link
              ...
              className={`mt-2 px-3 py-2 rounded-md font-medium text-center ${
