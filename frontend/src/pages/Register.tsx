      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center gap-12">
        ...
        >
          ...
          <p className="text-xl text-gray-400 mb-8 leading-relaxed">
            Join thousands of developers collaborating in real-time. Create your free account in seconds.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-400">Unlimited rooms & files</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
            <h2 className="text-2xl font-bold text-black mb-6">Create your account</h2>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 mb-6 bg-white border-2 border-gray-200 rounded-lg font-medium text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all"
            >
